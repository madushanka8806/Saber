<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchIteambyName.aspx.cs" Inherits="SaberWebApplication.SearchIteambyName" %>
...
<body>
    ...
    <table class="style1">
        ...
        <asp:TextBox ID="txtProductName" runat="server"></asp:TextBox>
             ...
             <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Product Name is Required" ClientIDMode="AutoID" ControlToValidate="txtProductName" ForeColor="Red"></asp:RequiredFieldValidator></td>
            <td>
